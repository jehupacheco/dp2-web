      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="demo-form2" method="POST" action="{{url('/vehiculos/'.$tipo_id.'/nuevo')}}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Precio (S/.) <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
