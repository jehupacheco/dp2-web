          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  <label for="organization-id" class="control-label col-md-3 col-sm-3 col-xs-12">Organization ID</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="organization-id" class="form-control col-md-7 col-xs-12" type="text" name="organization-id">
                  </div>
                </div>
